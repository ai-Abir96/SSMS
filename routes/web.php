...
Route::get('/employee/job/position/create', 'E_job_positionController@RoleCreate')->name('EJpostion_create_page');
Route::post('/employee/job/position/create', 'E_job_positionController@create')->name('EJpostion_create');
