...
Route::get('/employee/job/position/index', 'E_job_positionController@index')->name('EJpostion_index');

Route::get('/employee/job/position/create', 'E_job_positionController@positioncreate')->name('EJpostion_create_page');
Route::post('/employee/job/position/create', 'E_job_positionController@store')->name('EJpostion_create');
