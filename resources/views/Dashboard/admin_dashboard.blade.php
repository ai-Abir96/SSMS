    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{ route('EJstatus_index') }}"><i class="fas fa-fw fa-folder"></i><span>Job Status</span></a>
          <a class="dropdown-item" href="{{ route('EJpostion_index') }}"><i class="fas fa-fw fa-folder"></i><span>Job Position</span></a>
        </div>
      </li>
