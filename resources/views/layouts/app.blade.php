...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/bootstrap4_5_3.min.js') }}" defer></script>
    <script src="{{ asset('js/jquery3_5_1.min.js') }}" defer></script>
    <script src="{{ asset('js/popper.min.js') }}" defer></script>
    <script src="{{ asset('js/app.js') }}" defer></script>
    <script src="{{ asset('js/employeeform.js') }}" defer></script>
