...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update Product Stock') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('stock_update', $stocks->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select id="cat" class="form-control" name="fcat_id" value="{{$stocks->categories->ct_name}}" >
                                <option value="{{$stocks->categories->id}}" >{{$stocks->categories->ct_name}}</option>
